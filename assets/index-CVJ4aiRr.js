 ...
 */var U0;function N1(){if(U0)return pt;U0=1;var r=Symbol.for("react.element"),e=Symbol.for("react.portal"),t=Symbol.for("react.fragment"),n=Symbol.for("react.strict_mode"),s=Symbol.for("react.profiler"),a=Symbol.for("react.provider"),l=Symbol.for("react.context"),u=Symbol.for("react.forward_ref"),f=Symbol.for("react.suspense"),d=Symbol.for("react.memo"),h=Symbol.for("react.lazy"),m=Symbol.iterator;function g(z){return z===null||typeof z!="object"?null:(z=m&&z[m]||z["@@iterator"],typeof z=="function"?z:null)}var _={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},S=Object.assign,M={};function x(z,Q,Ce){this.props=z,this.context=Q,this.refs=M,this.updater=Ce||_}x.prototype.isReactComponent={},x.prototype.setState=function(z,Q){if(typeof z!="object"&&typeof z!="function"&&z!=null)throw Error("setState(...): takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,z,Q,"setState")},x.prototype.forceUpdate=function(z){this.updater.enqueueForceUpdate(this,z,"forceUpdate")};function y(){}y.prototype=x.prototype;function b(z,Q,Ce){this.props=z,this.context=Q,this.refs=M,this.updater=Ce||_}var T=b.prototype=new y;T.constructor=b,S(T,x.prototype),T.isPureReactComponent=!0;var w=Array.isArray,C=Object.prototype.hasOwnProperty,P={current:null},I={key:!0,ref:!0,__self:!0,__source:!0};function D(z,Q,Ce){var ne,le={},Me=null,ye=null;if(Q!=null)for(ne in Q.ref!==void 0&&(ye=Q.ref),Q.key!==void 0&&(Me=""+Q.key),Q)C.call(Q,ne)&&!I.hasOwnProperty(ne)&&(le[ne]=Q[ne]);var de=arguments.length-2;if(de===1)le.children=Ce;else if(1<de){for(var De=Array(de),$e=0;$e<de;$e++)De[$e]=arguments[$e+2];le.children=De}if(z&&z.defaultProps)for(ne in de=z.defaultProps,de)le[ne]===void 0&&(le[ne]=de[ne]);return{$$typeof:r,type:z,key:Me,ref:ye,props:le,_owner:P.current}}function A(z,Q){return{$$typeof:r,type:z.type,key:Q,ref:z.ref,props:z.props,_owner:z._owner}}function R(z){return typeof z=="object"&&z!==null&&z.$$typeof===r}function F(z){var Q={"=":"=0",":":"=2"};return"$"+z.replace(/[=:]/g,function(Ce){return Q[Ce]})}var O=/\/+/g;function B(z,Q){return typeof z=="object"&&z!==null&&z.key!=null?F(""+z.key):Q.toString(36)}function G(z,Q,Ce,ne,le){var Me=typeof z;(Me==="undefined"||Me==="boolean")&&(z=null);var ye=!1;if(z===null)ye=!0;else switch(Me){case"string":case"number":ye=!0;break;case"object":switch(z.$$typeof){case r:case e:ye=!0}}if(ye)return ye=z,le=le(ye),z=ne===""?"."+B(ye,0):ne,w(le)?(Ce="",z!=null&&(Ce=z.replace(O,"$&/")+"/"),G(le,Q,Ce,"",function($e){return $e})):le!=null&&(R(le)&&(le=A(le,Ce+(!le.key||ye&&ye.key===le.key?"":(""+le.key).replace(O,"$&/")+"/")+z)),Q.push(le)),1;if(ye=0,ne=ne===""?".":ne+":",w(z))for(var de=0;de<z.length;de++){Me=z[de];var De=ne+B(Me,de);ye+=G(Me,Q,Ce,De,le)}else if(De=g(z),typeof De=="function")for(z=De.call(z),de=0;!(Me=z.next()).done;)Me=Me.value,De=ne+B(Me,de++),ye+=G(Me,Q,Ce,De,le);else if(Me==="object")throw Q=String(z),Error("Objects are not valid as a React child (found: "+(Q==="[object Object]"?"object with keys {"+Object.keys(z).join(", ")+"}":Q)+"). If you meant to render a collection of children, use an array instead.");return ye}function Z(z,Q,Ce){if(z==null)return z;var ne=[],le=0;return G(z,ne,"","",function(Me){return Q.call(Ce,Me,le++)}),ne}function q(z){if(z._status===-1){var Q=z._result;Q=Q(),Q.then(function(Ce){(z._status===0||z._status===-1)&&(z._status=1,z._result=Ce)},function(Ce){(z._status===0||z._status===-1)&&(z._status=2,z._result=Ce)}),z._status===-1&&(z._status=0,z._result=Q)}if(z._status===1)return z._result.default;throw z._result}var $={current:null},H={transition:null},ee={ReactCurrentDispatcher:$,ReactCurrentBatchConfig:H,ReactCurrentOwner:P};function te(){throw Error("act(...) is not supported in production builds of React.")}return pt.Children={map:Z,forEach:function(z,Q,Ce){Z(z,function(){Q.apply(this,arguments)},Ce)},count:function(z){var Q=0;return Z(z,function(){Q++}),Q},toArray:function(z){return Z(z,function(Q){return Q})||[]},only:function(z){if(!R(z))throw Error("React.Children.only expected to receive a single React element child.");return z}},pt.Component=x,pt.Fragment=t,pt.Profiler=s,pt.PureComponent=b,pt.StrictMode=n,pt.Suspense=f,pt.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED=ee,pt.act=te,pt.cloneElement=function(z,Q,Ce){if(z==null)throw Error("React.cloneElement(...): The argument must be a React element, but you passed "+z+".");var ne=S({},z.props),le=z.key,Me=z.ref,ye=z._owner;if(Q!=null){if(Q.ref!==void 0&&(Me=Q.ref,ye=P.current),Q.key!==void 0&&(le=""+Q.key),z.type&&z.type.defaultProps)var de=z.type.defaultProps;for(De in Q)C.call(Q,De)&&!I.hasOwnProperty(De)&&(ne[De]=Q[De]===void 0&&de!==void 0?de[De]:Q[De])}var De=arguments.length-2;if(De===1)ne.children=Ce;else if(1<De){de=Array(De);for(var $e=0;$e<De;$e++)de[$e]=arguments[$e+2];ne.children=de}return{$$typeof:r,type:z.type,key:le,ref:Me,props:ne,_owner:ye}},pt.createContext=function(z){return z={$$typeof:l,_currentValue:z,_currentValue2:z,_threadCount:0,Provider:null,Consumer:null,_defaultValue:null,_globalName:null},z.Provider={$$typeof:a,_context:z},z.Consumer=z},pt.createElement=D,pt.createFactory=function(z){var Q=D.bind(null,z);return Q.type=z,Q},pt.createRef=function(){return{current:null}},pt.forwardRef=function(z){return{$$typeof:u,render:z}},pt.isValidElement=R,pt.lazy=function(z){return{$$typeof:h,_payload:{_status:-1,_result:z},_init:q}},pt.memo=function(z,Q){return{$$typeof:d,type:z,compare:Q===void 0?null:Q}},pt.startTransition=function(z){var Q=H.transition;H.transition={};try{z()}finally{H.transition=Q}},pt.unstable_act=te,pt.useCallback=function(z,Q){return $.current.useCallback(z,Q)},pt.useContext=function(z){return $.current.useContext(z)},pt.useDebugValue=function(){},pt.useDeferredValue=function(z){return $.current.useDeferredValue(z)},pt.useEffect=function(z,Q){return $.current.useEffect(z,Q)},pt.useId=function(){return $.current.useId()},pt.useImperativeHandle=function(z,Q,Ce){return $.current.useImperativeHandle(z,Q,Ce)},pt.useInsertionEffect=function(z,Q){return $.current.useInsertionEffect(z,Q)},pt.useLayoutEffect=function(z,Q){return $.current.useLayoutEffect(z,Q)},pt.useMemo=function(z,Q){return $.current.useMemo(z,Q)},pt.useReducer=function(z,Q,Ce){return $.current.useReducer(z,Q,Ce)},pt.useRef=function(z){return $.current.useRef(z)},pt.useState=function(z){return $.current.useState(z)},pt.useSyncExternalStore=function(z,Q,Ce){return $.current.useSyncExternalStore(z,Q,Ce)},pt.useTransition=function(){return $.current.useTransition()},pt.version="18.3.1",pt}var O0;function ym(){return O0||(O0=1,Mh.exports=N1()),Mh.exports}/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var B0;function U1(){return B0||(B0=1,function(r){function e(H,ee){var te=H.length;H.push(ee);e:for(;0<te;){var z=te-1>>>1,Q=H[z];if(0<s(Q,ee))H[z]=ee,H[te]=Q,te=z;else break e}}function t(H){return H.length===0?null:H[0]}function n(H){if(H.length===0)return null;var ee=H[0],te=H.pop();if(te!==ee){H[0]=te;e:for(var z=0,Q=H.length,Ce=Q>>>1;z<Ce;){var ne=2*(z+1)-1,le=H[ne],Me=ne+1,ye=H[Me];if(0>s(le,te))Me<Q&&0>s(ye,le)?(H[z]=ye,H[Me]=te,z=Me):(H[z]=le,H[ne]=te,z=ne);else if(Me<Q&&0>s(ye,te))H[z]=ye,H[Me]=te,z=Me;else break e}}return ee}function s(H,ee){var te=H.sortIndex-ee.sortIndex;return te!==0?te:H.id-ee.id}if(typeof performance=="object"&&typeof performance.now=="function"){var a=performance;r.unstable_now=function(){return a.now()}}else{var l=Date,u=l.now();r.unstable_now=function(){return l.now()-u}}var f=[],d=[],h=1,m=null,g=3,_=!1,S=!1,M=!1,x=typeof setTimeout=="function"?setTimeout:null,y=typeof clearTimeout=="function"?clearTimeout:null,b=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function T(H){for(var ee=t(d);ee!==null;){if(ee.callback===null)n(d);else if(ee.startTime<=H)n(d),ee.sortIndex=ee.expirationTime,e(f,ee);else break;ee=t(d)}}function w(H){if(M=!1,T(H),!S)if(t(f)!==null)S=!0,q(C);else{var ee=t(d);ee!==null&&$(w,ee.startTime-H)}}function C(H,ee){S=!1,M&&(M=!1,y(D),D=-1),_=!0;var te=g;try{for(T(ee),m=t(f);m!==null&&(!(m.expirationTime>ee)||H&&!F());){var z=m.callback;if(typeof z=="function"){m.callback=null,g=m.priorityLevel;var Q=z(m.expirationTime<=ee);ee=r.unstable_now(),typeof Q=="function"?m.callback=Q:m===t(f)&&n(f),T(ee)}else n(f);m=t(f)}if(m!==null)var Ce=!0;else{var ne=t(d);ne!==null&&$(w,ne.startTime-ee),Ce=!1}return Ce}finally{m=null,g=te,_=!1}}var P=!1,I=null,D=-1,A=5,R=-1;function F(){return!(r.unstable_now()-R<A)}function O(){if(I!==null){var H=r.unstable_now();R=H;var ee=!0;try{ee=I(!0,H)}finally{ee?B():(P=!1,I=null)}}else P=!1}var B;if(typeof b=="function")B=function(){b(O)};else if(typeof MessageChannel<"u"){var G=new MessageChannel,Z=G.port2;G.port1.onmessage=O,B=function(){Z.postMessage(null)}}else B=function(){x(O,0)};function q(H){I=H,P||(P=!0,B())}function $(H,ee){D=x(function(){H(r.unstable_now())},ee)}r.unstable_IdlePriority=5,r.unstable_ImmediatePriority=1,r.unstable_LowPriority=4,r.unstable_NormalPriority=3,r.unstable_Profiling=null,r.unstable_UserBlockingPriority=2,r.unstable_cancelCallback=function(H){H.callback=null},r.unstable_continueExecution=function(){S||_||(S=!0,q(C))},r.unstable_forceFrameRate=function(H){0>H||125<H?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):A=0<H?Math.floor(1e3/H):5},r.unstable_getCurrentPriorityLevel=function(){return g},r.unstable_getFirstCallbackNode=function(){return t(f)},r.unstable_next=function(H){switch(g){case 1:case 2:case 3:var ee=3;break;default:ee=g}var te=g;g=ee;try{return H()}finally{g=te}},r.unstable_pauseExecution=function(){},r.unstable_requestPaint=function(){},r.unstable_runWithPriority=function(H,ee){switch(H){case 1:case 2:case 3:case 4:case 5:break;default:H=3}var te=g;g=H;try{return ee()}finally{g=te}},r.unstable_scheduleCallback=function(H,ee,te){var z=r.unstable_now();switch(typeof te=="object"&&te!==null?(te=te.delay,te=typeof te=="number"&&0<te?z+te:z):te=z,H){case 1:var Q=-1;break;case 2:Q=250;break;case 5:Q=1073741823;break;case 4:Q=1e4;break;default:Q=5e3}return Q=te+Q,H={id:h++,callback:ee,priorityLevel:H,startTime:te,expirationTime:Q,sortIndex:-1},te>z?(H.sortIndex=te,e(d,H),t(f)===null&&H===t(d)&&(M?(y(D),D=-1):M=!0,$(w,te-z))):(H.sortIndex=Q,e(f,H),S||_||(S=!0,q(C))),H},r.unstable_shouldYield=F,r.unstable_wrapCallback=function(H){var ee=g;return function(){var te=g;g=ee;try{return H.apply(this,arguments)}finally{g=te}}}}(Th)),Th}var V0;function O1(){return V0||(V0=1,wh.exports=U1()),wh.exports}/**
 * @license React
...
`)}function wR(r,e){let t;switch(e){case fE:t="Linear";break;case dE:t="Reinhard";break;case hE:t="Cineon";break;case pE:t="ACESFilmic";break;case gE:t="AgX";break;case _E:t="Neutral";break;case mE:t="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",e),t="Linear"}return"vec3 "+r+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const Qc=new se;function TR(){Ct.getLuminanceCoefficients(Qc);const r=Qc.x.toFixed(4),e=Qc.y.toFixed(4),t=Qc.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${r}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
...
`)+`
`+y);const T=b+x+l,w=b+y+u,C=Ov(s,s.VERTEX_SHADER,T),P=Ov(s,s.FRAGMENT_SHADER,w);s.attachShader(M,C),s.attachShader(M,P),t.index0AttributeName!==void 0?s.bindAttribLocation(M,0,t.index0AttributeName):t.morphTargets===!0&&s.bindAttribLocation(M,0,"position"),s.linkProgram(M);function I(F){if(r.debug.checkShaderErrors){const O=s.getProgramInfoLog(M).trim(),B=s.getShaderInfoLog(C).trim(),G=s.getShaderInfoLog(P).trim();let Z=!0,q=!0;if(s.getProgramParameter(M,s.LINK_STATUS)===!1)if(Z=!1,typeof r.debug.onShaderError=="function")r.debug.onShaderError(s,M,C,P);else{const $=zv(s,C,"vertex"),H=zv(s,P,"fragment");console.error("THREE.WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(M,s.VALIDATE_STATUS)+`
...
void main(){
  ...
  gl_FragColor = vec4(color, alpha);
                      ...
                      crt-overlay text-white`,children:["  ",pn.jsxs("div",{className:"font-mono text-sm text-cyan-electric tracking-wider",children:["PROG [",Math.floor(f).toString().padStart(3,"0"),"%]"]}),pn.jsxs("div",{className:"flex gap-3 items-center",children:[pn.jsxs("div",{className:"relative group",children:[pn.jsx("input",{type:"range",min:"0",max:"1",step:"0.01",value:l,onChange:d=>u(parseFloat(d.target.value)),className:`w-24 h-1 bg-gray-900/80 rounded-sm cursor-cyber
                               ...
                               disabled:text-cyan-electric/30`,disabled:!s,onKeyDown:d=>{d.key==="Enter"&&d.stopPropagation()},children:n?"[[ PAUSE ]]":"[[ PLAY ]]"}),pn.jsxs("button",{onClick:t,className:`px-3 py-1 border-2 border-magenta-neon/40 
                               text-magenta-neon hover:border-magenta-neon 
                               hover:text-magenta-neon hover:bg-magenta-neon/10
                               font-mono text-xs tracking-wider
                               transition-all duration-200 ease-crt
                               disabled:text-magenta-neon/30`,disabled:a<=1,children:["NEXT_TRACK",">",">"]})]})]})]})}class w3{constructor(e=4,t=3){this.video=document.createElement("video"),this.video.src="/joke.mp4",this.video.loop=!1,this.video.muted=!1,this.videoTexture=new yw(this.video),this.videoTexture.minFilter=wn,this.videoTexture.magFilter=wn;const n=new Qr(e,t),s=new nu({map:this.videoTexture,transparent:!0,opacity:0});this.videoMesh=new ui(n,s);const a=new Qr(e,t*.25),l=document.createElement("canvas"),u=l.getContext("2d");l.width=512,l.height=128,u.fillStyle="#000",u.fillRect(0,0,l.width,l.height),u.font="bold 20px monospace",u.fillStyle="#ffffff",u.textAlign="center",u.textBaseline="middle";const f=["Noé: Tout le monde monte dans","l'arche par ordre alphabétique","","","Le zèbre qui a déjà les couilles dans l'eau:"],d=25,h=l.height/2-(f.length-1)*d/2;f.forEach((_,S)=>{u.fillText(_,l.width/2,h+S*d)});const m=new lx(l),g=new nu({map:m,transparent:!0,opacity:0});this.textMesh=new ui(a,g),this.group=new Xl,this.group.add(this.videoMesh),this.group.add(this.textMesh),this.videoMesh.position.y=-t*.1,this.textMesh.position.y=t*.6}setPosition(e,t,n){this.group.position.set(e,t,n)}setScale(e,t,n){this.group.scale.set(e,t,n)}show(){return this.video.currentTime=0,bt.to(this.videoMesh.material,{opacity:1,duration:.5}),bt.to(this.textMesh.material,{opacity:1,duration:.5}),this.video.play(),new Promise(e=>{this.video.onended=()=>{bt.to(this.videoMesh.material,{opacity:0,duration:.5}),bt.to(this.textMesh.material,{opacity:0,duration:.5,onComplete:e})}})}dispose(){this.videoMesh.geometry.dispose(),this.videoMesh.material.dispose(),this.textMesh.geometry.dispose(),this.textMesh.material.dispose(),this.videoTexture.dispose(),this.textMesh.material.map&&this.textMesh.material.map.dispose(),this.video.remove()}}function T3(){const[r,e]=Ft.useState(!1),t=Ft.useRef(null);Ft.useEffect(()=>{if(!window.scene)return;const s=new w3(6,4);return s.setPosition(-2,25,5),s.setScale(.8,.8,.8),s.group.rotation.x=-Math.PI/2,t.current=s,window.scene.add(s.group),()=>{window.scene.remove(s.group),s.dispose()}},[]);const n=async()=>{if(!r&&t.current){e(!0);try{await t.current.show()}finally{e(!1)}}};return pn.jsx("button",{onClick:n,disabled:r,className:`fixed bottom-4 left-4 bg-black/80 backdrop-blur-sm
                     ...
                     crt-overlay
                     !text-[#33ff33]`,children:"[//] BLAGUE.EXE"})}const C3=()=>{var R;const r=Ft.useRef(null),[e,t]=Ft.useState(0),[n,s]=Ft.useState(""),[a,l]=Ft.useState(.1),[u,f]=Ft.useState(0);Ft.useEffect(()=>{let F=0;const O=ep[e],B=setInterval(()=>{if(F<O.length){const G=O.substring(0,F+1);s(G),r.current&&r.current.updateText(G),F++}else clearInterval(B)},15);return()=>clearInterval(B)},[e]),Ft.useEffect(()=>{const F=O=>{O.key==="Enter"&&n.length===ep[e].length&&e<ep.length-1&&(t(B=>B+1),s(""))};return window.addEventListener("keypress",F),()=>window.removeEventListener("keypress",F)},[e,n]);const d=Ft.useRef(null),h=Ft.useRef(null),m=Ft.useRef(null),g=Ft.useRef(null),_=Ft.useRef(null),S=Ft.useRef(null),[M,x]=Ft.useState(!1),[y,b]=Ft.useState(!1),T=Ft.useRef(null),[w]=Ft.useState(()=>{const F=new M3;return F.maxDecibels=-3,F.minDecibels=-24,F}),[C]=Ft.useState(()=>new S3);Ft.useState({luminance:!1,distortion:!1,aberration:!1,scanlines:!1,glow:!1});const P=async()=>{var F;try{((F=w.audioContext)==null?void 0:F.state)==="suspended"&&await w.audioContext.resume(),await w.play(),T.current&&(T.current.connectAudio(w),T.current.resetMesh()),b(!0)}catch(O){console.error("Erreur lecture:",O)}},I=()=>{w.pause(),b(!1)},D=async()=>{var F;try{await w.nextTrack(),f(0),(F=w.audio)!=null&&F.buffer&&await C.detectBPM(w.audio.buffer)}catch(O){console.error("Track change error:",O)}};Ft.useEffect(()=>((async()=>{var O;await w.loadAudioBuffer(),(O=w.audio)!=null&&O.buffer&&await C.detectBPM(w.audio.buffer),C.addEventListener("beat",()=>{var B,G;(G=(B=T.current)==null?void 0:B.onBPMBeat)==null||G.call(B)})})(),()=>{w.audio&&(w.audio.stop(),w.audio.disconnect())}),[w,C,w.currentTrackIndex]),Ft.useEffect(()=>{const F=new ox;window.scene=F,m.current=F,F.background=new ft(0);const O=new Vi(60,window.innerWidth/window.innerHeight,.1,1e3);O.position.z=5,O.position.y=30,O.rotation.x=-Math.PI/2,g.current=O;const B=new Db(8,6);B.setPosition(-2,25,5.5),B.mesh.rotation.x=-Math.PI/2,r.current=B,F.add(B.mesh),F.add(B.mesh);const G=new bb(d.current);h.current=G,G.init(F,O),x(!0);const Z=new jP({audioManager:w,bpmManager:C,camera:g.current});Z.init(),F.add(Z),T.current=Z;let q,$=0;const H=()=>{var ee;if(q=requestAnimationFrame(H),w!=null&&w.isPlaying){w.update();const te=Date.now();if(te-$>=100){const z=w.getCurrentTime(),Q=w.currentTrackDuration||1,Ce=z/Q*100;console.log(`Time: ${z.toFixed(2)}s / ${Q.toFixed(2)}s = ${Ce.toFixed(2)}%`),f(Ce),$=te}}(ee=T.current)!=null&&ee.update&&T.current.update(),G.render()};return H(),()=>{var ee,te;for(cancelAnimationFrame(q),r.current&&r.current.dispose(),_.current&&_.current.dispose(),S.current&&S.current.dispose(),h.current&&h.current.dispose(),T.current&&(T.current.destroyMesh(),(ee=T.current.material)==null||ee.dispose(),(te=T.current.geometry)==null||te.dispose(),F.remove(T.current));F.children.length>0;)F.remove(F.children[0]);delete window.scene}},[w,C]),Ft.useEffect(()=>{const F=()=>{var G,Z;if(!g.current||!h.current)return;const O=window.innerWidth,B=window.innerHeight;g.current.aspect=O/B,g.current.updateProjectionMatrix(),h.current.setSize(O,B),T.current&&((Z=(G=T.current).setResolution)==null||Z.call(G,O,B))};return window.addEventListener("resize",F),()=>window.removeEventListener("resize",F)},[]);const A=F=>{w.setVolume(F),l(F)};return pn.jsxs("div",{className:"relative w-full h-full",children:[pn.jsx("canvas",{ref:d,className:"absolute inset-0 w-full h-full"}),M&&pn.jsxs("div",{className:"fixed top-0 left-0 right-0 z-50 flex justify-between items-start pt-4 px-4 pb-0 backdrop-blur-sm border-cyan-electric/30 crt-overlay",children:[pn.jsx(E3,{onPlay:P,onPause:I,onNext:D,isPlaying:y,isAudioReady:!!((R=w.audio)!=null&&R.buffer),playlistLength:w.playlist.length,volume:a,onVolumeChange:A,progress:u}),pn.jsx(T3,{})]})]})};function A3(){return pn.jsx("div",{className:"fixed inset-0 w-full h-full bg-black",children:pn.jsx(C3,{})})}V1.createRoot(document.getElementById("root")).render(pn.jsx(Ft.StrictMode,{children:pn.jsx(A3,{})}));
