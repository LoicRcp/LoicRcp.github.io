...
C'est pourquoi je candidate aujourd'hui au poste de responsable informatique (ou membre de l'équipe informatique). Étudiant en GI06, passionné de sport, jeux vidéo et musique, ce qui me motive particulièrement c'est la création - surtout en informatique. Qu'il s'agisse de projets créatifs, utilitaires ou même professionnels, je prends toujours du plaisir à concevoir et développer des systèmes qui ont un impact tangible.`,

  `Le Pic serait un terrain d'expérimentation idéal pour mettre en place des solutions qui amélioreraient encore l'expérience de ce lieu unique. J'ai une réelle envie de contribuer à ce projet qui me tient à cœur et qui a tant enrichi mon parcours à l'UTC.

> load background.dat
[LOADING EXPERIENCE DATA...]
[SUCCESS]

Mon parcours en informatique a débuté avec le creative coding et les simulations graphiques, inspiré par des mentors comme Daniel Shiffman. Cette passion m'a mené du développement de simulations en Processing jusqu'au freelance, où j'ai conçu des scripts et des outils pour des clients tout en poursuivant mon DUT.`,

  `À l'UTC, j'ai repris le temps de m'intéresser au simulations :Colonies de fourmis, systèmes de particules, algorithmes génétiques... Des projets qui m'ont valu d'excellents résultats, notamment en IA04/AI30, mais surtout c'est quelque chose qui me stimule énormément.

Cette expérience variée, entre projets créatifs et solutions concrètes, me donne un bon bagage technique pour ce rôle. Et comme amateur de musique électronique et de démoscene, je pense pouvoir apporter une sensibilité qui correspond bien à l'esprit du Pic, tout en restant disponible pour contribuer à d'autres aspects de l'association quand nécessaire.`,

  `> scan CV_associatif.dat
[...]
...
└── SKIUT 2024 - Développeur mobile`,

  `IUT Informatique (2019-2021)
└── BDE - Développeur 
